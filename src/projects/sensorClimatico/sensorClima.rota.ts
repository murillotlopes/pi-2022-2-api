...
sensorClimaRota.patch('/:equipamento', validaToken, sensorClimaControlador.atualizarEquipamento) // atualização dos dados do equipamento
sensorClimaRota.get('/lista', sensorClimaControlador.listar) // lista de equipamentos cadastrado
sensorClimaRota.get('/:equipamento', sensorClimaControlador.filtrarPorEquipamento) // dados registrado sob um equipamento
